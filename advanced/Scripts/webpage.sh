...
UpdateSpeedTest() {
    ...
    screen -S pimod -dm bash -c "curl -sSL https://github.com/ipitio/pihole-speedtest/raw/master/mod.sh | bash -s -- up ${args[2]}"
}
...
UninstallSpeedTest() {
    ...
    screen -S pimod -dm bash -c "curl -sSL https://github.com/ipitio/pihole-speedtest/raw/master/mod.sh | bash -s -- un"
}
