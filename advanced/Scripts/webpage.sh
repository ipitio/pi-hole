...
UpdateSpeedTest() {
    ...
    tmux send-keys -t pimod "curl -sSLN https://github.com/ipitio/pihole-speedtest/raw/ipitio/mod.sh | bash -s -- up ${args[2]}" Enter
}
...
UninstallSpeedTest() {
    ...
    tmux new-session -d -s pimod
    tmux send-keys -t pimod "curl -sSLN https://github.com/ipitio/pihole-speedtest/raw/ipitio/mod.sh | bash -s -- un" Enter
}
