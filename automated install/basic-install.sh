...
welcomeDialogs() {
    ...
    dialog --no-shadow --clear --keep-tite \
        --backtitle "Welcome" \
            --title "Pi-hole Automated Installer : Speedtest Mod Included" \
            --msgbox "\\n\\nThis installer will transform your device into a network-wide ad blocker! https://github.com/arevindh/pihole-speedtest" \
            "${r}" "${c}" \
            --and-widget --clear \
